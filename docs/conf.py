...
latex_documents = [
    ("index", "meta.tex", "Django Meta Documentation", "Iacopo Spalletti", "manual"),
]
...
man_pages = [("index", "django-meta", "Django Meta Documentation", ["Iacopo Spalletti"], 1)]
